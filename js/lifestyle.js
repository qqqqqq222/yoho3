$(function(){
	...
	$.get("../JSON/lifestyle.json",function(data){
		console.log(data)
		$.each(data[0],function(index,value){
			$("<li><a href='###'><img src='"+value.url+"' alt='' /></a></li>").appendTo($("#gory"));
			
		})

		$.each(data[1],function(index,value){
			$("<li><a href='###'><img src='"+value.url+"' alt='' /></a></li>").appendTo($("#gory2"));
			
		})

		$.each(data[2],function(index,value){
			$("<li><a href='###'><img src='"+value.url+"' alt='' /></a></li>").appendTo($("#gory3"));
			
		})

		$.each(data[3],function(index,value){
			$("<li><a href='###'><img src='"+value.url+"' alt='' /></a></li>").appendTo($("#gory4"));
